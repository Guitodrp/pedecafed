...
class Usuarios extends BaseController {
    ...
    public function editar($id = null) {
        ...
        if ($usuario->deletado_em != null) {
            return redirect()->back()->with('info', "O usuário $usuario->nome encontra-se excluído.Portanto, não é possivel editá-lo");
        }
    ...
    public function atualizar($id = null) {
        if ($this->request->getMethod() === 'post') {
            ...
            if ($usuario->deletado_em != null) {
                return redirect()->back()->with('info', "O usuário $usuario->nome já encontra-se excluído. Portanto não é possive edita-lo.");
            }
    ...
    public function excluir($id = null) {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            return redirect()->to(site_url('admin/usuarios'))->with('sucesso', "Usuario $usuario->nome excluído com sucesso!");
        }
