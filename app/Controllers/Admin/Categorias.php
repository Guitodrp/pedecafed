...
class Categorias extends BaseController {
    ...
    public function index() {
        ...
        return view('Admin/Categorias/index', $data); // diretorios sempre com a inicial maiuscula - view sempre minuscula
    }
    ...
    public function editar($id = null) {
        ...
        if ($categoria->deletado_em != null) {
            return redirect()->back()->with('info', "A categoria $categoria->nome encontra-se excluída.Portanto, não é possivel editá-la");
        }
    ...
    public function atualizar($id = null) {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($categoria->deletado_em != null) {
                return redirect()->back()->with('info', "A categoria $categoria->nome já encontra-se excluída. Portanto não é possive edita-lá.");
            }
    ...
    public function desfazerExclusao($id = null) {
        ...
        if ($categoria->deletado_em == null) {
            return redirect()->back()->with('info', 'Apenas categorias excluidas podem ser recuperadas');
        }
    ...
    private function buscaCategoriaOu404(int $id = null) {
        ...
        if (!$id || !$categoria = $this->categoriaModel->withDeleted(true)->where('id', $id)->first()) {
            throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound("Nao encontramos a categoria $id");
        }
        return $categoria;
    }
