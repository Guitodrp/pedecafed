...
<?php echo $this->section('titulo') ?> <?php echo $titulo; ?> 
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Escolha a medida do produto </label>
                    ...
                    <div class="form-group col-md-4">
                        <label>Produto Customizável</label>
                ...
                <a href="<?php echo site_url("admin/produtos/show/$produto->id") ?>" class="btn btn-light mt-4 btn-sm ">
                                        ...
                                        <?php foreach ($produtoEspecificacoes as $especificacao): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo site_url("admin/produtos/excluirespecificacao/$especificacao->id/$especificacao->produto_id") ?>" class="btn bagde badge-danger btn-sm">
                                                        &nbsp;X&nbsp;      
                                                    </a>
                                                </td>
                                            </tr>
