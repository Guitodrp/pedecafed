...
// chamando o formulario de edicao e cadastro em uma view diferente pelo include
    ...
    <div class="col-lg-5 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="<?php echo site_url("admin/produtos/especificacoes/$especificacao->produto_id") ?>" class="btn btn-light btn-sm ">
