            ...
            <div class="card-body">
                ...
                <?php if ($forma->id == 1): ?>
                    <div class="alert alert-primary" role="alert">
                        A forma de pagamento <strong><?php echo esc($forma->nome); ?></strong> não pode ser <span class="text-danger">editada ou excluída</span>, pois essa opção sera
                        vinculada ao envio de troco quando o cliente estiver no <strong>Checkout</strong>
                ...
                <div class="mt-4">
                    ...
                    <?php else: ?>
                        <a href="<?php echo site_url("admin/formas/desfazerexclusao/$forma->id") ?>" class="btn btn-dark btn-sm">
