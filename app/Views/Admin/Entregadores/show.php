        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php if($entregador->imagem): ?>
                    ...
                    <?php else: ?>
                    <img class="card-img-top w-75"  src=<?php echo site_url('admin/images/default-user.png'); ?> alt="Produto sem imagem no momento">
                    <?php endif; ?>
                    <hr>
                </div> 
                ...
                <div class="mt-4">
                    ...
                    <?php else: ?>
                        <a href="<?php echo site_url("admin/entregadores/desfazerexclusao/$entregador->id") ?>" class="btn btn-dark btn-sm">
