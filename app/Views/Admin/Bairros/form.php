...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control money" name="valor_entrega" id="valor_entrega" value="<?php echo old('valor_entrega', esc(number_format($bairro->valor_entrega, 2))); ?>"></input>
    </div> 
</div>
...
<button id="btn-salvar" type="submit" class="btn btn-primary btn-sm">
