    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <input id="btn-editar-pedido" type="submit" class="btn btn-success btn-sm" value="Atualizar Situação">

                <a href="<?php echo site_url("admin/pedidos/show/$pedido->codigo") ?>" class="btn btn-light btn-sm ">
...
<script>
    $(document).ready(function () {
        ...
        $("form").submit(function () {
            ...
            $("#btn-editar-pedido").val('Atualizando o pedido ..');
        });
    });
