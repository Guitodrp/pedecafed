...
$routes->group('admin', static function ($routes) {
    ...
    //post
    $routes->post('formas/atualizar/(:num)', 'Admin\FormasPagamento::atualizar/$1'); //sao metodos post 
    ...
    $routes->match(['get', 'post'], 'expedientes', 'Admin\Expedientes::expedientes/$1');
});

// cada vez que eu acessar o login ele redireciona para o metodo novo e depois aplica o filtro de visitante que impede de ir ao login novamente
